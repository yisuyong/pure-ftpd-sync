...
GLOBAL0(struct sockaddr_storage
            ctrlconn);        /* stdin/stdout, for using the same ip number */
...
GLOBAL0(signed char userchroot); /* 0=don't chroot() by default for regular
                                    users 1=chroot except members of the trusted
                                    group 2=chroot everyone */
